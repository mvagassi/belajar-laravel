<x-layout>
    ...
    {{-- <article class="max-w-screen-md py-4"></article>
        ...
        <div>
            By
            <a href=""
                class="hover:underline text-base text-gray-500"></a> |
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    ...
                    <address class="flex items-center my-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900">
                            ...
                            <div>
                                <a href="/posts?author={{ $post->author->username }}" rel="author" class="text-xl font-bold text-gray-900 hover:underline">{{ $post->author->name }}</a>
